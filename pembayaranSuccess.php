...
<main class="main-container-stock-selesai">
    ...
    <section id="topbar mb-3">
        <div class="container product-topbar fixed-top">
            <div class="row">
                <div class="col-8">
                    <h4 class="title pt-3 pb-2">Penjualan Selesai</h4>   
                </div>
                <div class="col-4 text-end topbar-icon">
                    ...
                    <ul class="dropdown-menu text-center" aria-labelledby="defaultDropdown">
                        ...
                        <li style="border-top: 1px solid #000;border-bottom: 1px solid #000;" ><a class="dropdown-item" href="penjualan.php">Kasir</a></li>
    ...
    <section id="pembayaran-success">
        <div class="container text-center">
            <div>
                ...
                <div class="text-stock-success">Penjualan Sukses!</div>
            </div>
            <div class="detail-success">
                <div class="row">
                    <div class="col-5">
                        <div class="label">Invoice</div>
                        <div class="date">T27012021-1</div>
                    </div>
                ...
                <div class="detail-label text-end">Lihat Detail Penjualan <img src="assets/images/keyboard_arrow_right.svg" alt=""></div>
            </div>
            <div class="row buttons">
                ...
                <div class="col-6">
                    <button class="btn btn-outline-success w-100 stock-button">
                        <img src="assets/images/store.svg" alt=""> List Penjualan
                    </button>
                </div>
                <div class="col-12">
                    <a href="penjualan.php">
                        <button class="btn btn-success w-100 tambah-button">
                            <img src="assets/images/add.svg" alt=""> Tambah Penjualan Baru
                        </button>
                    </a>
                </div>
            </div>
