...
<main class="main-container-stock">
    ...
    <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="search-stock">
                                <form action="penjualan.php" class="d-flex">
                        ...
                        <div class="col-2">
                            <form action="scanner.php" name="scanner" method="POST">
                                <input type="hidden" value="penjualan" name="detect-scanner">
        ...
        <!-- Tab Penjualan -->
        <div class="tab-pane fade show active" id="pills-retur-penjualan" role="tabpanel" aria-labelledby="pills-retur-penjualan-tab">
            <section id="data-penjualan">
                <div class="text-white">
                    <div class="row data-penjualan">
                        <div class="col-6 label">
